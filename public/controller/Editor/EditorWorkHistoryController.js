angular
.module('Editor')
.controller('EditorWorkHistoryController', ['$scope', '$rootScope', '$location','$window', '$http',EditorWorkHistoryController])
;
function EditorWorkHistoryController($scope,$rootScope,$location,$window,$http){
	var refresh = function(){
		$.ajax({
			type: 'Post',
			url: '/get_work_history_of_editor_user',
			dataType: 'json',
