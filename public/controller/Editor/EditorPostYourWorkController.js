angular
.module('Editor')
.controller('EditorPostYourWorkController', ['$scope', '$rootScope', '$location','$window', '$http',EditorPostYourWorkController])
...
;
function EditorPostYourWorkController($scope,$rootScope,$location,$window,$http){
	$('#file-fr').fileinput({
        language: 'fr',
        uploadUrl: '#',
	...
	$scope.onvideoUpload = function(){
        ...
        $.ajax({
	        ...
	        success: function (data) {
	        	if(data){
	        		window.location.href = '/Editor.html#/post_my_work_history';
	        	}
	        }
		});
};
