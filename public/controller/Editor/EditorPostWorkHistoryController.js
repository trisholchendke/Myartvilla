...
.module('Editor')
.run(['$rootScope',run])
.controller('EditorPostWorkHistoryController', ['$scope', '$rootScope', '$location','$window','$http','$timeout',EditorPostWorkHistoryController])
...
;
function EditorPostWorkHistoryController($scope,$rootScope,$location,$window,$http,$timeout){
	 $timeout(function(){
