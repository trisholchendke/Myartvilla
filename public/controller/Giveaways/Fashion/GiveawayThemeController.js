...
//		    		$scope.post['theme_url'] = 'http://localhost:8080/Fashion.html#/giveaways/+'$scope.post['theme_id'];
		            $.ajax({
		    	        type: 'Post',
		    	        url: '/post_your_theme',
		    	        dataType: 'json',
...
//		    	        		alert(JSON.stringify(data.theme_id));
		    	        		...
		    	        		window.location.href = 'Fashion.html#/set_question/' + theme_id;
//		    	        		location.href="/Fashion.html#/audience_quiz_details"
