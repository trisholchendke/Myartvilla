...
//		    		$scope.post['theme_url'] = 'http://localhost:8080/Writer.html#/giveaways/+'$scope.post['theme_id'];
		            $.ajax({
		    	        type: 'Post',
		    	        url: '/post_your_theme',
		    	        dataType: 'json',
...
//		    	        		alert(JSON.stringify(data.theme_id));
		    	        		...
		    	        		window.location.href = 'Writer.html#/set_question/' + theme_id;
//		    	        		location.href="/Writer.html#/audience_quiz_details"
