angular
.module('ShortFilms')
.controller('ShortFilmslive_nowController', ['$scope', '$rootScope', '$location','$window', '$http','socket','$routeParams',ShortFilmslive_nowController])
.factory('socket',['$rootScope',socket])
;
function ShortFilmslive_nowController($scope,$rootScope,$location,$window,$http,socket,$routeParams){
