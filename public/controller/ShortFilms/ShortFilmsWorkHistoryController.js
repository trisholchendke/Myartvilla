...
.module('ShortFilms')
.run(['$rootScope',run])
.controller('ShortFilmsWorkHistoryController', ['$scope', '$rootScope', '$location','$window','$http','$timeout',ShortFilmsWorkHistoryController])
...
;
function ShortFilmsWorkHistoryController($scope,$rootScope,$location,$window,$http,$timeout){
...
//	$timeout(function(){
//	    $scope.url = 'https://www.youtube.com/watch?v=0naXLtMKUlA';
...
//		  }
	...
	var refresh = function(){
		$.ajax({
	        type: 'Post',
	        url: '/get_short_films_user_work_history',
	        dataType: 'json',
...
//	               alert(JSON.stringify(data[0].post_owner[0],null,2));
	            });
	        }
		});
	}
