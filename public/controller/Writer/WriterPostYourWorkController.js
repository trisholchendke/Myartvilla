angular
.module('Writer')
.controller('WriterPostYourWorkController', ['$scope', '$rootScope', '$location','$window', '$http',WriterPostYourWorkController])
...
;
function WriterPostYourWorkController($scope,$rootScope,$location,$window,$http){
	...
	$scope.onvideoUpload = function(){
        ...
        $.ajax({
	        ...
	        success: function (data) {
	        	if(data){
	        		window.location.href = '/Writer.html#/post_my_work_history';
	        	}
	        }
		});
};
...
//		alert(JSON.stringify($scope.post));
	 ...
	 $scope.categories = 
		 [
			  ...
			  {
				  "id": "5",
				  "maincategory": "lifecycle/culture"
			  },
			  {
				  "id": "6",
				  "maincategory": "family"
