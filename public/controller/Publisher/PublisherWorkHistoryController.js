angular
.module('Publisher')
.controller('PublisherWorkHistoryController', ['$scope', '$rootScope', '$location','$window', '$http',PublisherWorkHistoryController])
;
function PublisherWorkHistoryController($scope,$rootScope,$location,$window,$http){
	var refresh = function(){
		$.ajax({
			type: 'Post',
			url: '/get_work_history_of_publisher_user',
			dataType: 'json',
