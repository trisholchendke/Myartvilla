angular
.module('Publisher')
.controller('PublisherPostYourWorkController', ['$scope', '$rootScope', '$location','$window', '$http',PublisherPostYourWorkController])
...
;
function PublisherPostYourWorkController($scope,$rootScope,$location,$window,$http){
	$('#file-fr').fileinput({
        language: 'fr',
        uploadUrl: '#',
	...
	$scope.onvideoUpload = function(){
        ...
        $.ajax({
	        ...
	        success: function (data) {
	        	if(data){
	        		window.location.href = '/Publisher.html#/post_my_work_history';
	        	}
	        }
		});
};
