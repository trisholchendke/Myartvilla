...
.run(['$rootScope',run])
.controller('CoverDesignerPostWorkHistoryController', ['$scope', '$rootScope', '$location','$window','$http','$timeout',CoverDesignerPostWorkHistoryController])
...
;
function CoverDesignerPostWorkHistoryController($scope,$rootScope,$location,$window,$http,$timeout){
	 $timeout(function(){
