...
.controller('CoverDesignerDashboardController', ['$scope', '$rootScope', '$location',	'$window', '$http',CoverDesignerDashboardController])
//.run(function($FB){
//	$FB.init('624903007694347');
//})
;
function CoverDesignerDashboardController($scope,$rootScope,$location,$window,$http){
	...
	var refresh = function(){
		$.ajax({
	        type: 'Post',
	        url: '/get_coverdesigner_dashboard_data',
	        dataType: 'json',
