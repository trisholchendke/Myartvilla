...
.controller('CoverDesignerUserProfileController', ['$scope', '$rootScope', '$location','$window', '$http',CoverDesignerUserProfileController])

;
function CoverDesignerUserProfileController($scope,$rootScope,$location,$window,$http){
	...
	$scope.show_profile_pic = function(){
		window.location.href = '/CoverDesigner.html#/show_profile_pics';
	}
...
//				$(".DateFrom").val(data[0].dob);
	...
	$scope.modify_profile_details = function(coming_object){
		$.ajax({
	        type: 'Post',
	        url: '/modify_coverdesigner_user_profile',
	        dataType: 'json',
	        data:coming_object,
	        success: function (data) {
	        	if(data){
	        		$scope.$apply(function () {
	        			...
	        			$scope.sucess = "Success!";
	        			 setTimeout(function () {
	        			        window.location.href = '/CoverDesigner.html#/dashboard';
	        			 }, 2000);
	        		});
	        	}
	        }
