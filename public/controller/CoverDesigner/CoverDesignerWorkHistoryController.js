...
.controller('CoverDesignerWorkHistoryController', ['$scope', '$rootScope', '$location','$window', '$http',CoverDesignerWorkHistoryController])
;
function CoverDesignerWorkHistoryController($scope,$rootScope,$location,$window,$http){
	var refresh = function(){
		$.ajax({
			type: 'Post',
			url: '/get_work_history_of_coverdesigner_user',
			dataType: 'json',
