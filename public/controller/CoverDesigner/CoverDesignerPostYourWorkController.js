...
.controller('CoverDesignerPostYourWorkController', ['$scope', '$rootScope', '$location','$window', '$http',CoverDesignerPostYourWorkController])
...
;
function CoverDesignerPostYourWorkController($scope,$rootScope,$location,$window,$http){
	$('#file-fr').fileinput({
        language: 'fr',
        uploadUrl: '#',
	...
	$scope.onvideoUpload = function(){
        ...
        $.ajax({
	        ...
	        success: function (data) {
	        	if(data){
	        		window.location.href = '/CoverDesigner.html#/post_my_work_history';
	        	}
	        }
		});
};
