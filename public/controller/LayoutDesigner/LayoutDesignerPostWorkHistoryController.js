...
.run(['$rootScope',run])
.controller('LayoutDesignerPostWorkHistoryController', ['$scope', '$rootScope', '$location','$window','$http','$timeout',LayoutDesignerPostWorkHistoryController])
...
;
function LayoutDesignerPostWorkHistoryController($scope,$rootScope,$location,$window,$http,$timeout){
	 $timeout(function(){
