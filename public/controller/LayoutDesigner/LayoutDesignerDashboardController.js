...
.controller('LayoutDesignerDashboardController', ['$scope', '$rootScope', '$location',	'$window', '$http','$timeout',LayoutDesignerDashboardController])
//.run(function($FB){
//	$FB.init('624903007694347');
//})
;
function LayoutDesignerDashboardController($scope,$rootScope,$location,$window,$http,$timeout){
	$timeout(function(){
	...
	var refresh = function(){
		$.ajax({
	        type: 'Post',
	        url: '/get_layoutdesigner_dashboard_data',
	        dataType: 'json',
