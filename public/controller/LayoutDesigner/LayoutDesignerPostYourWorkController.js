...
.controller('LayoutDesignerPostYourWorkController', ['$scope', '$rootScope', '$location','$window', '$http',LayoutDesignerPostYourWorkController])
...
;
function LayoutDesignerPostYourWorkController($scope,$rootScope,$location,$window,$http){
	$('#file-fr').fileinput({
        language: 'fr',
        uploadUrl: '#',
	...
	$scope.onvideoUpload = function(){
        ...
        $.ajax({
	        ...
	        success: function (data) {
	        	if(data){
	        		window.location.href = '/LayoutDesigner.html#/post_my_work_history';
	        	}
	        }
		});
};
