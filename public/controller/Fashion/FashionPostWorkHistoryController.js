...
.module('Fashion')
.run(['$rootScope',run])
.controller('FashionPostWorkHistoryController', ['$scope', '$rootScope', '$location','$window','$http','$timeout',FashionPostWorkHistoryController])
...
;
function FashionPostWorkHistoryController($scope,$rootScope,$location,$window,$http,$timeout){
