angular
.module('Admin')
.controller('CoverDesignerController', ['$scope', '$rootScope', '$location',	'$window', '$http','DTOptionsBuilder','DTColumnBuilder','sweet',CoverDesignerController])
;
function CoverDesignerController($scope,$rootScope,$location,$window,$http,DTOptionsBuilder, DTColumnBuilder,sweet){
...
//		 })
		 ...
		 $scope.editArtistUser = function(artist) {
			...
			$.ajax({
		        type: 'Post',
		        url: '/get_all_coverdesigner_user',
		        dataType: 'json',
		        data:{name:"pravin"},
