angular
.module('Admin')
.controller('WriterController', ['$scope', '$rootScope', '$location',	'$window', '$http','DTOptionsBuilder','DTColumnBuilder','sweet',WriterController])
;
function WriterController($scope,$rootScope,$location,$window,$http,DTOptionsBuilder, DTColumnBuilder,sweet){
