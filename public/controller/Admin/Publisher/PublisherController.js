angular
.module('Admin')
.controller('PublisherController', ['$scope', '$rootScope', '$location',	'$window','$http','DTOptionsBuilder','DTColumnBuilder','sweet',PublisherController])
;
function PublisherController($scope,$rootScope,$location,$window,$http,DTOptionsBuilder,DTColumnBuilder,sweet){
