angular
.module('Admin')
.controller('LayoutDesignerController', ['$scope', '$rootScope', '$location','$window', '$http','DTOptionsBuilder','DTColumnBuilder','sweet',LayoutDesignerController])
;
function LayoutDesignerController($scope,$rootScope,$location,$window,$http,DTOptionsBuilder, DTColumnBuilder,sweet){
...
//		 })
		 ...
		 $scope.editArtistUser = function(artist) {
			...
			$.ajax({
		        type: 'Post',
		        url: '/get_all_layoutdesigner_user',
		        dataType: 'json',
		        data:{name:"pravin"},
