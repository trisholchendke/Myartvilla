angular
.module('Admin')
.controller('ArtistController', ['$scope', '$rootScope', '$location',	'$window', '$http','DTOptionsBuilder','DTColumnBuilder','sweet',ArtistController])
;
function ArtistController($scope,$rootScope,$location,$window,$http,DTOptionsBuilder, DTColumnBuilder,sweet){
