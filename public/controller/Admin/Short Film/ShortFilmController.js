angular
.module('Admin')
.controller('ShortFilmController', ['$scope', '$rootScope', '$location',	'$window', '$http','DTOptionsBuilder','DTColumnBuilder','sweet',ShortFilmController])
;
function ShortFilmController($scope,$rootScope,$location,$window,$http,DTOptionsBuilder, DTColumnBuilder,sweet){
